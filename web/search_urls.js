...
export const SEARCH_ENGINES = [
  { key: "google",       label: "Google",        template: "https://www.google.com/search?q={name}",                                                                          template_with_auth: null,                                                            with_authorship: false, icon: "search" },
  { key: "imagen",       label: "Imágenes",      template: "https://www.google.com/search?q={name}&tbm=isch",                                                               template_with_auth: null,                                                            with_authorship: false, icon: "image" },
  { key: "documentos",   label: "Documentos",    template: "https://www.google.com/search?q={name}+%28filetype%3Adoc+OR+filetype%3Adocx+OR+filetype%3Atxt%29",           template_with_auth: null,                                                            with_authorship: false, icon: "description" },
  { key: "pdf",          label: "PDF",           template: "https://www.google.com/search?q={name}+filetype%3Apdf",                                                        template_with_auth: null,                                                            with_authorship: false, icon: "picture_as_pdf" },
  { key: "wikipedia",    label: "Wikipedia",     template: "https://en.wikipedia.org/wiki/Special:Search?search={name}",                                                  template_with_auth: null,                                                            with_authorship: false, icon: "menu_book" },
  ...
  { key: "researchgate", label: "ResearchGate",  template: "https://www.researchgate.net/search/publication?q={name}",                                                    template_with_auth: null,                                                            with_authorship: false, icon: "science" },
  { key: "plos",         label: "PLOS",          template: "https://journals.plos.org/plosone/search?query={name}",                                                       template_with_auth: null,                                                            with_authorship: false, icon: "article" },
  { key: "academia",     label: "Academia.edu",  template: "https://www.academia.edu/search?q={name}",                                                                    template_with_auth: null,                                                            with_authorship: false, icon: "school" },
  { key: "scielo",       label: "Scielo",        template: "https://search.scielo.org/?q={name}",                                                                         template_with_auth: null,                                                            with_authorship: false, icon: "travel_explore" },
  ...
  { key: "youtube",      label: "YouTube",       template: "https://www.youtube.com/results?search_query={name}",                                                         template_with_auth: null,                                                            with_authorship: false, icon: "play_circle" },
  { key: "zootaxa",      label: "Zootaxa",       template: "https://www.biotaxa.org/Zootaxa/search?query={name}",                                                         template_with_auth: null,                                                            with_authorship: false, icon: "bug_report" },
  { key: "scribd",       label: "Scribd",        template: "https://www.scribd.com/search?query={name}",                                                                  template_with_auth: null,                                                            with_authorship: false, icon: "auto_stories" },
];
...
export function buildSearchUrls(scientificName, authorship) {
  ...
  return SEARCH_ENGINES.map(e => {
    ...
    if (e.with_authorship && authQ && e.template_with_auth) {
      url = e.template_with_auth.replace("{name}", nameQ).replace("{auth}", authQ);
    } else {
