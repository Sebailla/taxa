...
- [ ] ODD-MAP-002 Verify and publish the tooling repair.
  - Verification: independent verifier approved; 192 related tests and Makefile dry-run contracts passed.

## Progress
ODD-MAP-001 is verified and ready to publish. The unrelated Next-generated `next-env.d.ts` drift remains deliberately excluded.